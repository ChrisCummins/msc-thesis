...
// less than a pre-determined value, then recursion will occur in a
// new thread. This means that the maximum total number of threads
// created is coarsely determined by the parallelisation depth and the
// number of sub-problems which is generated by the divide() function,
// known as the degree. For a degree of 2:
//
