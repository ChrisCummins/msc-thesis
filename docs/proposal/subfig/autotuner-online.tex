...
% Nodes:
\node (t-start) [block, fill=gray!10] {\textbf{User program}};
...
\node (t-binary3) [block, fill=gray!10, right of=t-compile, text width=3cm, xshift=.5cm, yshift=.2cm] {};
\node (t-binary2) [block, fill=gray!10, right of=t-compile, text width=3cm, xshift=.6cm, yshift=.1cm] {};
\node (t-binary) [block, fill=gray!10, right of=t-compile, text width=3cm, xshift=.7cm] {\textbf{Multiversioned binary}};

\node (training-set) [database, fill=gray!10, below of=t-procs]
