...
\newcommand{\DocumentFontSize}{12pt}
\newcommand{\DocumentHorizontalMargin}{15mm}
\newcommand{\DocumentTopMargin}{10mm}
\newcommand{\DocumentBottomMargin}{20mm}

\newcommand{\IncludePageNumbers}{1}

%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document and Layout %%
%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[twocolumn,leqno,\DocumentFontSize]{\DocumentClass}
...
\usepackage[a4paper,
            ...
            bottom = \DocumentBottomMargin{}]{geometry}

% Multi-column support.
\usepackage{multicol}

% Disable page numbers if not desired.
\ifnum\IncludePageNumbers=0
...
% Control the depth at which sections get numbered. Levels are:
%
%     0 - Chapter
%     1 - Section
%     2 - Subsection
...
% Define a custom \maketitle layout. See:
%
%  http://ctan.sharelatex.com/tex-archive/macros/latex/contrib/titling/titling.pdf
%
\usepackage{titling}
...
\postdate{\end{center} \vskip -1.2em}
...
\DeclareMathOperator*{\Values}{Values}
\DeclareMathOperator*{\SplitEntropy}{SplitEntropy}
\DeclareMathOperator*{\GainRatio}{GainRatio}
