...
\newcommand{\DocumentFontSize}{11pt}
\newcommand{\DocumentHorizontalMargin}{30mm}
\newcommand{\DocumentVerticalMargin}{25mm}

\newcommand{\ReferenceFile}{ref.bib}
\newcommand{\IncludePageNumbers}{1}

%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document and Layout %%
%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[\DocumentFontSize]{\DocumentClass}
...
\preauthor{\begin{center} \large \vskip .8em}
\postauthor{\end{center}}
\predate{\begin{center} \large \vskip -.8em}
...
\IfFileExists{\ReferenceFile}{\addbibresource{\ReferenceFile}}
...
\DeclareMathOperator*{\InfoGain}{InfoGain}
