...
Speedups have been low. While performance is heavily influenced by the
parameters, I have not been able to improve significantly over the
defaults (best speedup is 12\%).
