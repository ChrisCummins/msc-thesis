...
% documents. Usage: \todo{Todo note}. The macros are conditional on
% the "draft" command. For production builds, comment this line out:
\def\draft{}

% Packages needed for \todo{} and \roughnotes{}.
\usepackage{color}

% \todo{} command.
\newcommand{\todo}[1]{
  \ifdef{\draft}
  {\textcolor{red}{\em\footnotesize#1}}
  {}
}
...
\newcommand{\note}[1]{
  \ifdef{\draft}
  {\textcolor{blue}{\em\footnotesize#1}}
  {}
}
