...
\TODO{Define mathematical notation used, and shorthand symbols for
  ``oracle'', etc\ldots}
...
\subsubsection{Skeleton implementations}
...
\subsubsection{Example application 1 - Mandelbrot Set}

\TODO{Definition, listing, and performance results.}

\subsubsection{Example application 1 -- Dot Product}
...
\subsubsection{Example application 2 --- Gaussian Blur}
