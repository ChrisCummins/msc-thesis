...
\item An empirical evaluation of the performance impact of values used
  ...
  using \input{gen/num_runtime_stats} test instances, showing how
  choice of workgroup size has an average
  $\input{gen/avg_possible_speedup}\times$ influence on runtime (max
...
\item The novel application of synthetic \TODO{(programatically
  ...
  autotuner for \input{gen/num_real_kernels} real world Stencil codes
  using synthetic benchmarks, showing that \FIXME{sexy result goes
    here}.
