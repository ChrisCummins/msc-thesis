...
dataset. It contains the methodology used to achieve empirical
performance data with which to base performance comparisons of
different workgroup sizes, and the steps necessary to obtain
repeatable results.
