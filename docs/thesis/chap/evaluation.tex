...
\caption[30 most refused parameters]{%
...
\caption[Classification speedups using 10-fold classification]{%
...
\end{subfigure}
\caption[Classification with regressors results]{%
...
\label{fig:coverage}
\end{subfigure}
\caption[Classification errors for 10-fold cross-validation]{%
