...
level of noise that meaningful comparisons can be made the performance
...
\caption{%
  ...
  (where $w < W_{max}(s) \forall S$), and higher for $w_r $ and $w_r$
  values which are multiples of 8. The space of oracle workgroup size
  frequencies is uneven and distributed.%
}
\label{fig:heatmaps}
\end{figure}
