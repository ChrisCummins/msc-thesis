...
the oracle workgroup size of scenarios. To evaluate the performance of
a classifier, a subset of scenarios $S_{training} \subset S$ are
labelled with the workgroup size which gave the best performance for
each. The classifier is trained on this labelled training data, and
...
\begin{figure}
\centering
\includegraphics{gen/img/classification-syn-real.pdf}
\caption{%
  Classification performance using synthetic-real.%
}
\end{figure}

\begin{figure}
\centering
\includegraphics{gen/img/classification-arch.pdf}
\caption{%
  Classification performance using cross-arch.%
}
\end{figure}

\begin{figure}
\centering
\includegraphics{gen/img/classification-kern.pdf}
\caption{%
  Classification performance using cross-kern.%
}
\end{figure}

\begin{figure}
\centering
\includegraphics{gen/img/classification-data.pdf}
\caption{%
  Classification performance using cross-data.%
}
\end{figure}
