...
\input{gen/ratio_refused_test_cases}\%

\input{gen/ratio_refused_params}\%
...
\TODO{Is this dependend on program, architecture, or dataset?}
...
\subsection{Static Tuning Performance}
