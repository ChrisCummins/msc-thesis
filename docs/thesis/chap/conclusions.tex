...
A further benefit of the synthetic stencil benchmark generator could
be for creating minimal test cases of refused OpenCL parameters, so
that bug reports could be filed with the relevant implementation
