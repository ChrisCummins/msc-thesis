...
$\input{gen/best_avg_classification_speedup_he}\times$ (max
$\input{gen/best_max_classification_speedup_he}\times$) over human
experts, and $\input{gen/best_avg_classification_speedup}\times$ (max
