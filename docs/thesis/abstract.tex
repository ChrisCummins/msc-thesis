\TODO{The rapid transition towards multicore hardware has left
application programmers requiring higher-level abstractions for coping
with the complexity of parallel programming. Algorithmic Skeletons
provide such abstractions but, without extensive tuning, typically
cannot compete with the performance of hand optimised code. This paper
proposes developing a dynamic, ``always-on'' autotuner for SkelCL, an
