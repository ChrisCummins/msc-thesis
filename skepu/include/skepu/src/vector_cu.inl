 ...
 */
template <typename T>
void Vector<T>::copyDataToAnInvalidDeviceCopy(DeviceMemPointer_CU<T> *copy, unsigned int deviceID)
{
 ...
 */
template <typename T>
typename Vector<T>::device_pointer_type_cu Vector<T>::updateDevice_CU(T* start, size_type numElements, unsigned int deviceID, bool copy, bool writeAccess, bool markOnlyLocalCopiesInvalid)
{
   ...
   {
      tempCopy = new DeviceMemPointer_CU<T>(start, numElements, Environment<int>::getInstance()->m_devices_CU.at(deviceID), m_nameVerbose);
      if(copy)
      {
 ...
 */
template <typename T>
bool Vector<T>::isVectorOnDevice_CU(unsigned int deviceID)
{
   typename std::map<std::pair< T*,size_type >, device_pointer_type_cu >::iterator result;
...
inline void Vector<T>::updateHost_CU(int deviceID) const
{
   ...
   Environment<int>::getInstance()->finishAll_CU(0, MAX_GPU_DEVICES+1);
   return;
#endif
...
*/
template <typename T>
bool Vector<T>::isModified_CU(unsigned int deviceID)
{
 ...
 */
template <typename T>
inline void Vector<T>::invalidateDeviceData_CU(int deviceID)
{
   typename std::map<std::pair< T*,size_type >, device_pointer_type_cu >::const_iterator it;
 ...
 */
template <typename T>
inline void Vector<T>::releaseDeviceAllocations_CU(int deviceID)
{
   typename std::map<std::pair< T*,size_type >, device_pointer_type_cu >::const_iterator it;
