...
{\
    ...
    {\
        ...
        datatype_CL.append(#type1);\
        func_CL.append(\
        datatype_CL + " " + funcName_CL + "(__local " + datatype_CL + "* " + #param1 + ", int stride)\n"\
        "{\n"\
        "   " #func "\n"\
        "}\n");\
    }\
...
{\
    ...
    {\
        ...
        constype_CL.append(#type1);\
        func_CL.append(\
        datatype_CL + " " + funcName_CL + "(__global " + datatype_CL + "* " + #param1 + "," + datatype_CL + " " + #param2 + ",int " + #xindex + ",int " + #yindex + ", " + constype_CL + " " + "dummy" + ")\n"\
        "{\n"\
        "   " #func "\n"\
        "}\n");\
    }\
...
{\
    ...
    {\
        ...
        constype_CL.append(#constType);\
        func_CL.append(\
        datatype_CL + " " + funcName_CL + "(__global " + datatype_CL + "* " + #param1 + "," + datatype_CL + " " + #param2 + ",int " + #xindex + ",int " + #yindex + ", " + constype_CL + " " + #const1 + ")\n"\
        "{\n"\
        "   " #func "\n"\
        "}\n");\
    }\
...
{\
    ...
    {\
        ...
        constype_CL.append(#constType);\
        func_CL.append(\
        datatype_CL + " " + funcName_CL + "(unsigned int " + #index + ", " + constype_CL + " " + #const1 + ")\n"\
        "{\n"\
        "   " #func "\n"\
        "}\n");\
    }\
...
{\
    ...
    {\
        ...
        constype_CL.append(#constType);\
        func_CL.append(\
        datatype_CL + " " + funcName_CL + "(unsigned int " + #xindex + ", unsigned int " + #yindex +", " + constype_CL + " " + #const1 + ")\n"\
        "{\n"\
        "   " #func "\n"\
        "}\n");\
    }\
