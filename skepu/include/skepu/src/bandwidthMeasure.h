...
const std::string BW_FILE_PATH("/home/usmda/gcf/banwidthMeasures.dat");
...
///////////////////////////////////////////////////////////////////////////////
double testDeviceToHostTransfer(unsigned int memSize, memoryMode memMode, bool wc)
{
...
////////////////////////////////////////////////////////
void printResultsReadable(unsigned int *memSizes, double* bandwidths, unsigned int count, memcpyKind kind, memoryMode memMode, int deviceId, bool wc)
{
...
//////////////////////////////////////////////////////////////////////
DevTimingStruct measurebandwidth(memoryMode memMode = PAGEABLE, int deviceId = 0, bool wc = false)
{
