...
{\
    ...
    __device__ type1 CU(type1 param1)\
    {\
        return CU(param1,const1);\
    }\
    __device__ type1 CU(type1 param1, constType const1)\
    {\
        func\
    }\
};
...
{\
    ...
    __device__ type1 CU(type1 param1, type1 param2, constType const1)\
    {\
        func\
    }\
};
...
{\
    ...
    __device__ type1 CU(type1 param1, type1 param2, type1 param3)\
    {\
        return CU(param1, param2, param3, const1);\
    }\
    __device__ type1 CU(type1 param1, type1 param2, type1 param3, constType const1)\
    {\
        func\
    }\
};
...
{\
    ...
    __device__ type1 CU(type1 * param1, int stride)\
    {\
        func\
    }\
};
