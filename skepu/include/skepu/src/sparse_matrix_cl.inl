 ...
 */
template <typename T>
typename SparseMatrix<T>::device_pointer_type_cl SparseMatrix<T>::updateDevice_CL(T* start, size_t elems, Device_CL* device, bool copy)
{
   ...
   {
      device_pointer_type_cl temp = new DeviceMemPointer_CL<T>(start, elems, device);
      if(copy)
      {
         //Make sure uptodate
         updateHost_CL();
 ...
 */
template <typename T>
typename SparseMatrix<T>::device_pointer_index_type_cl SparseMatrix<T>::updateDevice_Index_CL(size_t* start, size_t elems, Device_CL* device, bool copy)
{
   DEBUG_TEXT_LEVEL3("SparseMatrix updating device CUDA\n")
   ...
   {
      device_pointer_index_type_cl temp = new DeviceMemPointer_CL<size_t>(start, elems, device);
      if(copy)
      {
         //Make sure uptodate
         updateHost_CL();
