...
typename SparseMatrix<T>::device_pointer_type_cu SparseMatrix<T>::updateDevice_CU(T* start, size_t elems, unsigned int deviceID, bool copy)
{
   ...
   {
      device_pointer_type_cu temp = new DeviceMemPointer_CU<T>(start, elems, Environment<int>::getInstance()->m_devices_CU.at(deviceID));
      if(copy)
      {
         //Make sure uptodate
         updateHost_CU();
...
typename SparseMatrix<T>::device_pointer_index_type_cu SparseMatrix<T>::updateDevice_Index_CU(size_t* start, size_t elems, unsigned int deviceID, bool copy)
{
   ...
   {
      device_pointer_index_type_cu temp = new DeviceMemPointer_CU<size_t>(start, elems, Environment<int>::getInstance()->m_devices_CU.at(deviceID), m_nameVerbose);
