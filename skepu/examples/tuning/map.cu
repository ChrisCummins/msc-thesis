...
//    skepu::ExecPlan execPlan1 = skepu::Tuner<square_f, MAP, square_f>("map_ex", 2, lowerBounds, upperBounds, memReadOpLoc, memWriteOpLoc)();
//    square.setExecPlan(execPlan1);
   
   skepu::ExecPlan execPlan[MAX_EXEC_PLANS];
   skepu::Tuner<square_f, MAP, square_f> tuner("map_ex", 2, lowerBounds, upperBounds);
   tuner(execPlan);
   square.setExecPlan(execPlan);
